...
export class DataComponent {
  ...
  historyData: Data;
  data: Data[] = [];
  displayedColumns: string[] = ['nombreRegistro', 'numero', 'moneda', 'precioVivienda', 'cuotaInicial', 'tasaEfectiva', 'numeroCuotas', 'periodoGraciaTotal', 'periodoGraciaParcial', 'cuota', 'diasRetraso', 'interesCompensatorio', 'interesMoratorio'];
